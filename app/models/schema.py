...
class VideoScriptParams:
    """
    {
      "video_subject": "Rare Photos You've Never Seen Before",
      "video_language": "",
      "paragraph_number": 1,
      "video_script_prompt": "",
    ...
    video_subject: Optional[str] = "Rare Photos You've Never Seen Before"
    video_language: Optional[str] = ""
    paragraph_number: int = Field(default=1, ge=1, le=10)
    video_script_prompt: str = Field(default="", max_length=2000)
    custom_system_prompt: str = Field(default="", max_length=8000)
...
class VideoTermsParams:
    ...
    video_script: Optional[str] = (
        "Rare photos you've never seen before. A baby mammoth preserved in a Moscow museum for centuries..."
    )
...
class TaskStatusData(BaseModel):
    """Stable public response structure for task queries."""
...
class TaskQueryResponse(BaseResponse):
    """Task query response containing video generation status and cross-posting state."""
    ...
    model_config = ConfigDict(
        json_schema_extra={
            "example": {
                ...
                "message": "success",
                "data": {
                    "video_script": "Rare photos you've never seen before..."
                },
            },
        }
    )
